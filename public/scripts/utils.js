...
// Auth: toggle Logout visibility and optional redirect (used by Home, Settings, Appearance, Soon)
async function checkAuth() {
    try {
        ...
        if (Logout) {
            Logout.style.display = data.authenticated ? "flex" : "none";
        }
        return data.authenticated;
    } catch (e) {
        if (document.querySelector(".Logout")) document.querySelector(".Logout").style.display = "none";
        return false;
    }
}
